...
test:			## Run tests. Params: {{ v=8.3 }}.
	...
	docker exec yii2-bootstrap4-php-1 sh -c "php -v && composer update && vendor/bin/phpunit --coverage-clover=coverage.xml"
	make down
...
static-analysis:	## Run code static analyze. Params: {{ v=8.3 }}.
	...
	docker exec yii2-bootstrap4-php-1 sh -c "php -v && composer update && vendor/bin/phpstan analyse --memory-limit 512M"
	make down
